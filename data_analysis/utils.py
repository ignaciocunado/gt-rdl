# Modified from https://github.com/snap-stanford/relbench-user-study/tree/main
...
DATASET_INFO = {
    ...
    'rel-avito': {
        ...
        'tasks': ['user-visits', 'user-clicks', 'ad-ctr', 'user-ad-visit']
    }
}
...
def db_setup(dataset_name: str, db_filename: str):
    ...
    try:
        ...
        for task_name in tasks:
            ...
            test_table = task.get_table("test", False).df  # noqa ADD LABELS TO TEST SET
